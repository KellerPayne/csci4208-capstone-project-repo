...
export const playerService = {
    createPlayer(name, subjectPrefix) {        // validates and creates a new player
        ...
        return players.create(name, subjectPrefix); // else it calls the DB layer to actually create the player
    },
